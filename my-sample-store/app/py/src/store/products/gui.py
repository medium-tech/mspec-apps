...
class ProductsIndexPage(tkinter.Frame):
    ...
    def _list_fetch(self):
        ...
        try:
            items = client_list_products(self.app.ctx, offset=self.list_offset, limit=self.list_page_size)
        ...
        for n in range(self.list_page_size):
            ...
            product_name_text.grid(row=n + self.list_items_row_offset, column=2, padx=padx)
            ...
            in_stock_text.grid(row=n + self.list_items_row_offset, column=4, padx=padx)
